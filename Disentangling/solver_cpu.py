...
class Solver(object):
    ...
    def viz_lines(self):
        ...
        ## gather 2 to save image with plot
        ...
        klds_2 = torch.cat([dim_wise_klds_2, total_klds_2], 1).cpu()
        ...
        if self.save_output:
            ...
            plt.plot(iters_2, recon_losses_2, linewidth=2.0)
            plt.tick_params(labelsize = 14)
            plt.xlabel('iteration',fontsize=14)
            plt.title('reconsturction loss', fontsize=14)
            fig.savefig(os.path.join(output_dir, 'graph_recon_loss.jpg'))

            fig = plt.figure(figsize=(10, 10), dpi=300)
            plt.plot(iters_2, betas_2,linewidth=2.0)
            plt.tick_params(labelsize = 14)
            plt.xlabel('iteration',fontsize=14)
            ...
            fig = plt.figure(figsize=(10, 10), dpi=300)
            plt.plot(iters_2, klds_2, linewidth=2.0)
            plt.tick_params(labelsize = 14)
            plt.legend(legend)
            plt.xlabel('iteration', fontsize=14)
            ...
            # fig = plt.figure(figsize=(10, 10), dpi=300)
            # plt.plot(iters_2, mus_2)
            # plt.legend(legend[:self.z_dim])
            # plt.xlabel('iteration')
            # plt.title('posterior mean')
            # fig.savefig(os.path.join(output_dir, 'graph_postmean.jpg'))

            # fig = plt.figure(figsize=(10, 10), dpi=300)
            # plt.plot(iters_2, vars_2)
            # plt.legend(legend[:self.z_dim])
            # plt.xlabel('iteration')
            # plt.title('posterior variance')
            # fig.savefig(os.path.join(output_dir, 'graph_postvar.jpg'))
