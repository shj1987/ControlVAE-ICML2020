            ...
            with variable_scope.variable_scope("loss"):
                ...
                if log_dir is not None and FLAGS.mode =='train':
                    ...
                    if 'cost' in FLAGS.model_name:
                        kl_weights = _cost_annealing(self.global_t, FLAGS.anneal_steps)
                    elif 'pid' in FLAGS.model_name:
                        kl_weights = self.pid_control.pid(self.avg_kld, FLAGS.Kp, FLAGS.Ki)
                    elif 'cyclical' in FLAGS.model_name:
                        kl_weights = _cyclical_annealing(self.global_t, FLAGS.cycle)
                else:
